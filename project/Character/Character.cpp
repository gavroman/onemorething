...
Swordman::Swordman(const int id) {
    std::string PLAYER;
    switch (current_player) {
        case PLAYER1: {
            PLAYER = "PLAYER1";
...
Berserker::Berserker(const int id) {
    std::string PLAYER;
    switch (current_player) {
        case PLAYER1: {
            PLAYER = "PLAYER1";
