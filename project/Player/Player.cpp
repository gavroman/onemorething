...
Human::Human(class Map field) {
    //chars = {};
    chars.push_back(std::make_shared<Scout>(10));
    chars.push_back(std::make_shared<Scout>(12));
    chars.push_back(std::make_shared<Scout>(13));
    chars.push_back(std::make_shared<Scout>(14));
    chars.push_back(std::make_shared<Scout>(15));
    chars.push_back(std::make_shared<Scout>(16));
    chars.push_back(std::make_shared<Scout>(17));
...
Bot::Bot(class Map field) {
    chars.push_back(std::make_shared<Scout>(210));
    chars.push_back(std::make_shared<Scout>(212));
    chars.push_back(std::make_shared<Scout>(213));
    chars.push_back(std::make_shared<Scout>(214));
    chars.push_back(std::make_shared<Scout>(215));
    chars.push_back(std::make_shared<Scout>(216));
    chars.push_back(std::make_shared<Scout>(217));
    for (auto &chr : chars) {
    	field.update_cell(chr, chr->get_current_cell());
    }
}
